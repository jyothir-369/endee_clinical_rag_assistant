...
# UPDATED FOR ENDEE
from services.endee_service import similarity_search
...
def _build_bm25_index() -> None:
    """Build BM25 index from all documents currently in Endee."""
    global _bm25, _corpus_docs

    # UPDATED FOR ENDEE
    # Fetch a large set of docs for BM25 corpus
    # We use a broad query to pull representative docs
    all_docs = similarity_search("medical clinical health disease treatment", k=200)
